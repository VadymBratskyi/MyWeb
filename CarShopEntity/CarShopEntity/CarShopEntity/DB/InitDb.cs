...
namespace CarShopEntity.DB
{
    public class InitDb : DropCreateDatabaseIfModelChanges<CodeContext>
    {
        ...
        private void InitModels(CodeContext context)
        {
            ...
            var model9 = new ModelCar() { Id = Guid.NewGuid(), ModelName = "328", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/328.jpg", IssueDate = new DateTime(), Car = car1 };
            var model10 = new ModelCar() { Id = Guid.NewGuid(), ModelName = "318", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/318.jpg", IssueDate = new DateTime(), Car = car1 };
            var model11 = new ModelCar() { Id = Guid.NewGuid(), ModelName = "mx5", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/mx5.jpg", IssueDate = new DateTime(), Car = car1 };
            var model12= new ModelCar() { Id = Guid.NewGuid(), ModelName = "x6", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/x6.jpg", IssueDate = new DateTime(), Car = car1 };
            var model13= new ModelCar() { Id = Guid.NewGuid(), ModelName = "mx6", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/mx6.jpg", IssueDate = new DateTime(), Car = car1 };
            var model14= new ModelCar() { Id = Guid.NewGuid(), ModelName = "i8", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/i8.jpg", IssueDate = new DateTime(), Car = car1 };
            var model15= new ModelCar() { Id = Guid.NewGuid(), ModelName = "440", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/440.jpg", IssueDate = new DateTime(), Car = car1 };
            var model16= new ModelCar() { Id = Guid.NewGuid(), ModelName = "m6", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/m6.jpg", IssueDate = new DateTime(), Car = car1 };
            var model17= new ModelCar() { Id = Guid.NewGuid(), ModelName = "630", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/630.jpg", IssueDate = new DateTime(), Car = car1 };
            var model18= new ModelCar() { Id = Guid.NewGuid(), ModelName = "430", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/430.jpg", IssueDate = new DateTime(), Car = car1 };
            var model19= new ModelCar() { Id = Guid.NewGuid(), ModelName = "750", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/750.jpg", IssueDate = new DateTime(), Car = car1 };
            var model20= new ModelCar() { Id = Guid.NewGuid(), ModelName = "730", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/730.jpg", IssueDate = new DateTime(), Car = car1 };
            var model21= new ModelCar() { Id = Guid.NewGuid(), ModelName = "520i", Color = "#000000", Engine = 2.5, Fuel = "benz", Price = 400.500m, ImgPath = "ImageSource/520i.jpg", IssueDate = new DateTime(), Car = car1 };
